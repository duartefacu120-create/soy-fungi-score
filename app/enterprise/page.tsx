                ...
                <div className="space-y-8 pb-10">
                    ...
                    <div className="grid gap-6 md:grid-cols-4">
                        ...
                        <MetricCard
                            ...
                            value={`${(totalHectares || 0).toLocaleString()} ha`}
                            ...
                            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                                <div className="space-y-4 max-w-xl">
                                    ...
                                    <div className="flex gap-10 pt-2">
                                        <div>
                                            <div className="text-3xl font-black text-gray-900">{(applyHectares || 0).toLocaleString()} <span className="text-sm font-normal text-gray-500">ha</span></div>
        ...
        return (
            <DashboardLayout>
                <div className="p-8 text-red-600 bg-red-50 rounded-xl border border-red-200">
                    <h2 className="font-bold text-xl mb-2">Error cargando el panel:</h2>
